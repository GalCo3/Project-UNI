...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            BusinessLayer.UserManagement um = new BusinessLayer.UserManagement();
            us = new UserService(um);
            bs = new BoardService(um);
        }
        ...
        {
            return us.createNewUser(email, password);
        }
        ...
        {
            return bs.setCapacity(email, boardName, limit, columnOrdinal);
        }
        ...
        {
            return bs.getCapacity(email, boardName, columnOrdinal);
        }
        ...
        {
            return bs.editTask(email, boardName, columnOrdinal, taskId, null, null, dueDate, 2);
        }
        ...
        {
            return bs.editTask(email, boardName, columnOrdinal, taskId, title, null, null, 0);
        ...
        {
            return bs.editTask(email, boardName, columnOrdinal, taskId, null, description, null, 1);
        }
        ...
        {
            return bs.moveTask(email, boardName, columnOrdinal, taskId);
        }
        ...
        {
            return bs.ListProgressTasks(email);
        }
